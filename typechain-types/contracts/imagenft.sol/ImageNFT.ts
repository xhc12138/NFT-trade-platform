...
export interface ImageNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "awardItem"
...
export interface ImageNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ImageNFT;
  waitForDeployment(): Promise<this>;

  interface: ImageNFTInterface;
  ...
  awardItem: TypedContractMethod<
    [user: AddressLike, metadatacid: string, cid: string, promptcid: string],
    [bigint],
    "nonpayable"
  >;
